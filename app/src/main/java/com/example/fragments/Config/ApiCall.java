...
public interface ApiCall {
    ...
    @POST("/account/"+DefaultConstants.ACCOUNT_ID+"/favorite")
    Call<FavFilmRequest> uptadeFavoriteStatus(@Header("Content-Type") String content_type
            , @Query("api_key") String api_key
            , @Query("session_id") String session_id, @Body FavFilmRequest favFilmRequest );
}
